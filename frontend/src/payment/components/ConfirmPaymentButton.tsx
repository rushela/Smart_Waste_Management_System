...
interface ConfirmPaymentButtonProps {
  ...
  onSubmit: (paymentData: { amount: number; timestamp: string; method: string }) => void;
}

const ConfirmPaymentButton: React.FC<ConfirmPaymentButtonProps> = ({ amount, isProcessing, onSubmit }) => {
