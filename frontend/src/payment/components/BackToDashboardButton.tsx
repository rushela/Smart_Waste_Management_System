...
const BackToDashboardButton: React.FC<BackToDashboardButtonProps> = ({ variant = 'primary', fullWidth = true, className = '' }) => {
...
interface BackToDashboardButtonAdvancedProps {
...
export const BackToDashboardButtonAdvanced: React.FC<BackToDashboardButtonAdvancedProps> = ({ 
  variant = 'primary', 
  size = 'lg',
  showIcon = true,
  customText,
